            ...
            >
              ...
              <template v-if="!selectedFile">
                ...
                <p class="text-caption text-grey">
                  <template v-if="extensionesPermitidas.length">
...
<script setup>
  ...
  const tipoDocumentoSeleccionado = computed(() =>
    tiposDocumento.value.find(t => t.id === uploadForm.tipo_documento_proyecto_id),
  )
  ...
  watch(() => uploadForm.tipo_documento_proyecto_id, () => {
